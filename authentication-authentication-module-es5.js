...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["authentication-authentication-module"], {
  ...
  function srcAppAuthenticationComponentsLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_services_user_info_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! src/app/services/user-info.service */
    "./src/app/services/user-info.service.ts");

    var LoginComponent = /*#__PURE__*/function () {
      function LoginComponent(authenticationService, router, userInfoService) {
      ...
      _createClass(LoginComponent, [{
        ...
        value: function login() {
          ...
          this.loginSubscription = this.authenticationService.login(this.loginFrom.value.username, this.loginFrom.value.currentPassword).subscribe(function (response) {
            delete localStorage.token;
            localStorage.token = response.token;
            delete localStorage.name;
            localStorage.username = _this.loginFrom.value.username;

            _this.userInfoService.setUserInfo();

            _this.router.navigate(['/food-planner']);
          });
        }
      }, {
        key: "register",
        value: function register() {
          ...
          this.registerSubscription = this.authenticationService.register(this.loginFrom.value.username, this.loginFrom.value.currentPassword).subscribe(function (response) {
            delete localStorage.token;
            localStorage.token = response.token;
            delete localStorage.name;
            localStorage.username = _this2.loginFrom.value.username;

            _this2.userInfoService.setUserInfo();

            _this2.router.navigate(['/food-planner']);
          });
        }
      }, {
        key: "ngOnDestroy",
    ...
    LoginComponent.ɵfac = function LoginComponent_Factory(t) {
      return new (t || LoginComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_authentication_service__WEBPACK_IMPORTED_MODULE_2__["AuthenticationService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_user_info_service__WEBPACK_IMPORTED_MODULE_4__["UserInfoService"]));
    };

    LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: LoginComponent,
      selectors: [["app-login"]],
      features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵProvidersFeature"]([_services_authentication_service__WEBPACK_IMPORTED_MODULE_2__["AuthenticationService"]])],
      decls: 14,
      vars: 3,
      consts: [[1, "container"], [1, "login-form"], ["id", "loginForm", 3, "formGroup", "ngSubmit"], ["for", "username"], ["type", "text", "formControlName", "username", "id", "username", "autocomplete", "username"], ["for", "password"], ["type", "password", "id", "password", "formControlName", "currentPassword", "autocomplete", "current-password"], ["type", "submit", "form", "loginForm", 3, "disabled"], [3, "disabled", "click"]],
  ...
  /***/
  function srcAppAuthenticationModelsUserTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppAuthenticationServicesAuthenticationServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_services_configuration_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! src/app/services/configuration.service */
    "./src/app/services/configuration.service.ts");

    var AuthenticationService = /*#__PURE__*/function () {
      function AuthenticationService(http, configuration) {
      ...
      _createClass(AuthenticationService, [{
        ...
        value: function login(username, password) {
          return this.http.post("".concat(this.configuration.nestJSServerUrl, "/login"), new _models_user__WEBPACK_IMPORTED_MODULE_1__["User"](username, password));
        }
      }, {
        key: "register",
        value: function register(username, password) {
          return this.http.post("".concat(this.configuration.nestJSServerUrl, "/register"), new _models_user__WEBPACK_IMPORTED_MODULE_1__["User"](username, password));
        }
      }]);
    ...
    AuthenticationService.ɵfac = function AuthenticationService_Factory(t) {
      return new (t || AuthenticationService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](src_app_services_configuration_service__WEBPACK_IMPORTED_MODULE_3__["ConfigurationService"]));
    };
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AuthenticationService, [{
        ...
        return [{
          ...
          type: src_app_services_configuration_service__WEBPACK_IMPORTED_MODULE_3__["ConfigurationService"]
        }];
      }, null);
    })();
    /***/
  ...
  function srcAppServicesConfigurationServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ConfigurationService = function ConfigurationService() {
